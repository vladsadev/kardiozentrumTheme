        ...
        <div class="relative mb-8 mt-8 md:mb-16 md:mt-12">
            ...
            <ul
                ...
                <?php while (have_posts()):
                    ...
                    <!-- SINGLE POST -->
                    <li
                            class="mb-2 flex max-h-[405px] min-h-48 flex-col gap-1 overflow-hidden
                                shadow-lg
                    ...
                    >
                        ...
                        <!--  Cuerpo  -->
                        <div class="flex h-1/2 px-2 flex-col bg-white items-start">
                            ...
                            <a class="my-2 text-red-dark hover:text-red-light font-bold"
                               href="<?= get_the_permalink() ?>">Leer Más </a>
                        </div>
                    </li>
                <?php endwhile; ?>
            </ul>
